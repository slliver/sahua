...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <form id="queryForm" method="POST" action="${ctx}/loan/daquan/list">
                ...
                <div class="col-md-12">
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">
                                <button type="button" id="addLoan" name="addLoan" class="btn btn-block btn-primary btn-sm" onclick="window.location.href = '${ctx}/loan/daquan/add'">添加</button>
                            </h3>
                        </div>
                        <!-- /.box-header -->
                                ...
                                <c:choose>
                                    <c:when test="${not empty dataList && fn:length(dataList) >0}">
                                        <c:forEach items="${dataList}" var="item">
                                            <tr>
                                                <td>
                                                    <button type="button" class="btn btn-primary btn-sm" onclick="window.location.href = '${ctx}/loan/daquan/${item.pkid}/edit'">编辑</button>
    ...
    $(".btn-delete").each(function() {
        $(this).unbind("click").bind("click", function(){
            ...
            if(window.confirm("确定删除当前数据么?")){
                window.location.href = ctx + '/loan/daquan/'+pkid+'/delete';
            }
            <!--

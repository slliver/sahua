            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-info">
                        ...
                        <form id="addForm" method="post" action="${ctx}/loan/datquan/update" class="form-horizontal">
...
<script type="text/javascript">
    ...
    $(function () {
        $("#btn-cancel").unbind("click").bind("click", function (event) {
            window.location.href = ctx + "/loan/daquan/list";
        });

        $("#btn-submit").unbind("click").bind("click", function (event) {
            ZW.Ajax.doRequest("addForm", ctx + "/loan/daquan/update", "", function (data) {
                // 失败
                if (data.res == 0) {

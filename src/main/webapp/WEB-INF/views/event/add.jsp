...
<c:import url="/WEB-INF/views/include/header.jsp">
    <c:param name="title">事件管理-添加</c:param>
</c:import>
<div class="wrapper">
    <!-- Main Header -->
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-info">
                        ...
                        <form id="addForm" method="POST" onsubmit="return false;" action="${ctx}/event/add" class="form-horizontal">
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="action" id="action" maxlength="20" placeholder="请输入事件编码"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="actionName" class="col-sm-2 control-label">事件名称</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="actionName" id="actionName" maxlength="20" placeholder="请输入事件名称"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="minPower" class="col-sm-2 control-label">最小金币数</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="minPower" id="minPower" maxlength="20" placeholder="请输入最小金币数"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="maxPower" class="col-sm-2 control-label">最大金币数</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="maxPower" id="maxPower" maxlength="20" placeholder="请输入最大金币数"/>
                                    </div>
                                </div>
                            </div>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $("#btn-submit").unbind("click").bind("click", function (event) {
            ZW.Ajax.doRequest("addForm", ctx + "/event/save", "", function (data) {
                // 失败
                if (data.res == 0) {

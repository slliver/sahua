...
<c:import url="/WEB-INF/views/include/header.jsp">
    <c:param name="title">帮帮维护-编辑</c:param>
</c:import>
<div class="wrapper">
    <!-- Main Header -->
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-info">
                        ...
                        <form id="addForm" method="POST" action="${ctx}/helpdata/update" class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="bankName" id="bankName" value="${card.bankName}"
                                               maxlength="50" placeholder="请输入帮帮名称"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="cardName" class="col-sm-2 control-label">帮帮副名称</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="cardName" id="cardName" maxlength="25" value="${card.cardName}" placeholder="请输入帮帮名称"/>
                                    </div>
                                </div>
                                <div class="form-group">
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $("#btn-submit").unbind("click").bind("click", function (event) {
            ZW.Ajax.doRequest("addForm", ctx + "/helpdata/update", "", function (data) {
                // 失败
                if (data.res == 0) {

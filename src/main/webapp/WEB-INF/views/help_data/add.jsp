...
<c:import url="/WEB-INF/views/include/header.jsp">
    <c:param name="title">帮帮维护-添加</c:param>
</c:import>
<div class="wrapper">
    <!-- Main Header -->
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-info">
                        ...
                        <form id="addForm" method="POST" action="${ctx}/helpdata/save" class="form-horizontal">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label for="bankName" class="col-sm-2 control-label">帮帮名称</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="bankName" id="bankName" maxlength="50" placeholder="请输入帮帮名称"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="cardName" class="col-sm-2 control-label">帮帮副名称</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="cardName" id="cardName" maxlength="25" placeholder="请输入帮帮名称"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="bankDes" class="col-sm-2 control-label">帮帮简介</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="label" id="label" maxlength="50"
                                               placeholder="请输入标签，以空格分开，比如：下款快 额度高"/>
                                    </div>
                                </div>
                                <div class="form-group">
...
<script type="text/javascript">
    ...
    $(function () {
        $("#btn-cancel").unbind("click").bind("click", function (event) {
            window.location.href = ctx + "/helpdata/list";
        });

        $("#btn-submit").unbind("click").bind("click", function (event) {
            ZW.Ajax.doRequest("addForm", ctx + "/helpdata/save", "", function (data) {
                // 失败
                if (data.res == 0) {
